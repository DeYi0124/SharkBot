...
class TeemoApi {
    ...
    req(endpoint, method, region, kwargs) {
        kwargs = kwargs || {};
        // Get spec.
        let ep;
        let sp;
...
(function (RegionalRoute) {
    ...
    RegionalRoute[RegionalRoute["ESPORTS"] = 10] = "ESPORTS";
...
(function (ValPlatformRoute) {
    ...
    /** Korea. */
    ValPlatformRoute[ValPlatformRoute["KR"] = 70] = "KR";
    /** Valorant E-Sports route. */
    ValPlatformRoute[ValPlatformRoute["ESPORTS"] = 95] = "ESPORTS";
...
},{"node-fetch":undefined,"url":undefined}]},{},[1])(1)
});
