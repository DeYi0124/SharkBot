...
(function (RiotAPITypes) {
    ...
    (function (METHOD_KEY) {
        ...
        (function (ACCOUNT) {
            ...
            ACCOUNT.GET_BY_ACCESS_TOKEN = "ACCOUNT.GET_BY_ACCESS_TOKEN";
        ...
        (function (CHAMPION_MASTERY) {
            ...
            CHAMPION_MASTERY.GET_TOP_CHAMPIONS = "CHAMPION_MASTERY.GET_TOP_CHAMPIONS";
        ...
        let CLASH;
        (function (CLASH) {
            CLASH.GET_PLAYERS_BY_PUUID = "CLASH.GET_PLAYERS_BY_PUUID";
        ...
        let LOL_CHALLENGES;
        (function (LOL_CHALLENGES) {
            LOL_CHALLENGES.GET_CONFIG = "LOL_CHALLENGES.GET_CONFIG";
            LOL_CHALLENGES.GET_PERCENTILES = "LOL_CHALLENGES.GET_PERCENTILES";
            LOL_CHALLENGES.GET_CONFIG_BY_ID = "LOL_CHALLENGES.GET_CONFIG_BY_ID";
            LOL_CHALLENGES.GET_LEADERBOARD_BY_ID = "LOL_CHALLENGES.GET_LEADERBOARD_BY_ID";
            LOL_CHALLENGES.GET_PERCENTILES_BY_ID = "LOL_CHALLENGES.GET_PERCENTILES_BY_ID";
            LOL_CHALLENGES.GET_PLAYER_DATA_BY_PUUID = "LOL_CHALLENGES.GET_PLAYER_DATA_BY_PUUID";
        })(LOL_CHALLENGES = METHOD_KEY.LOL_CHALLENGES || (METHOD_KEY.LOL_CHALLENGES = {}));
        let LOR_DECK;
        (function (LOR_DECK) {
            LOR_DECK.GET_DECKS_FOR_PLAYER = "LOR_DECK.GET_DECKS_FOR_PLAYER";
            LOR_DECK.POST_CREATE_DECK_FOR_PLAYER = "LOR_DECK.POST_CREATE_DECK_FOR_PLAYER";
        })(LOR_DECK = METHOD_KEY.LOR_DECK || (METHOD_KEY.LOR_DECK = {}));
        let LOR_INVENTORY;
        (function (LOR_INVENTORY) {
            LOR_INVENTORY.GET_CARDS_OWNED_BY_PLAYER = "LOR_INVENTORY.GET_CARDS_OWNED_BY_PLAYER";
        })(LOR_INVENTORY = METHOD_KEY.LOR_INVENTORY || (METHOD_KEY.LOR_INVENTORY = {}));
        let LOR_MATCH;
        (function (LOR_MATCH) {
        ...
        let SUMMONER;
        (function (SUMMONER) {
            SUMMONER.GET_BY_RSO_PUUID = "SUMMONER.GET_BY_RSO_PUUID";
        ...
        (function (TFT_LEAGUE) {
            ...
            TFT_LEAGUE.GET_TOP_RATED_LADDER_BY_QUEUE = "TFT_LEAGUE.GET_TOP_RATED_LADDER_BY_QUEUE";
        ...
        (function (TFT_SUMMONER) {
            ...
            TFT_SUMMONER.GET_BY_ACCESS_TOKEN = "TFT_SUMMONER.GET_BY_ACCESS_TOKEN";
        ...
        let VAL_RANKED;
        (function (VAL_RANKED) {
            VAL_RANKED.GET_LEADERBOARD_BY_QUEUE = "VAL_RANKED.GET_LEADERBOARD_BY_QUEUE";
        })(VAL_RANKED = METHOD_KEY.VAL_RANKED || (METHOD_KEY.VAL_RANKED = {}));
...
})(RiotAPITypes = exports.RiotAPITypes || (exports.RiotAPITypes = {}));
