...
class RiotAPI {
    ...
    get account() {
        return {
            ...
            getByAccessToken: ({ region, accessToken, }) => this.request(region, _types_1.RiotAPITypes.METHOD_KEY.ACCOUNT.GET_BY_ACCESS_TOKEN, {}, {
    ...
    get championMastery() {
        return {
            ...
            getTopChampions: ({ region, summonerId, params, }) => this.request(region, _types_1.RiotAPITypes.METHOD_KEY.CHAMPION_MASTERY.GET_TOP_CHAMPIONS, { summonerId }, {
    ...
    get clash() {
        return {
            getPlayersByPUUID: ({ region, puuid, }) => this.request(region, _types_1.RiotAPITypes.METHOD_KEY.CLASH.GET_PLAYERS_BY_PUUID, { puuid }, { id: `${region}.clash.getPlayersByPUUID.${puuid}` }),
    ...
    get lolChallenges() {
        return {
            getConfig: ({ region, }) => this.request(region, _types_1.RiotAPITypes.METHOD_KEY.LOL_CHALLENGES.GET_CONFIG, {}, { id: `${region}.lolChallenges.getConfig` }),
            getPercentiles: ({ region, }) => this.request(region, _types_1.RiotAPITypes.METHOD_KEY.LOL_CHALLENGES.GET_PERCENTILES, {}, { id: `${region}.lolChallenges.getPercentiles` }),
            getConfigById: ({ region, challengeId, }) => this.request(region, _types_1.RiotAPITypes.METHOD_KEY.LOL_CHALLENGES.GET_CONFIG_BY_ID, { challengeId }, { id: `${region}.lolChallenges.getConfigById.${challengeId}` }),
            getLeaderboardById: ({ region, challengeId, params, }) => this.request(region, _types_1.RiotAPITypes.METHOD_KEY.LOL_CHALLENGES.GET_LEADERBOARD_BY_ID, { challengeId }, {
                id: `${region}.lolChallenges.getLeaderboardById.${challengeId}`,
                params,
            }),
            getPercentilesById: ({ region, challengeId, }) => this.request(region, _types_1.RiotAPITypes.METHOD_KEY.LOL_CHALLENGES.GET_PERCENTILES_BY_ID, { challengeId }, { id: `${region}.lolChallenges.getPercentilesById.${challengeId}` }),
            getPlayerDataByPUUID: ({ region, puuid, }) => this.request(region, _types_1.RiotAPITypes.METHOD_KEY.LOL_CHALLENGES.GET_PLAYER_DATA_BY_PUUID, { puuid }, { id: `${region}.lolChallenges.getPlayerDataByPUUID.${puuid}` }),
        };
    }
    get lorDeck() {
        return {
            getDecksForPlayer: ({ region, accessToken, }) => this.request(region, _types_1.RiotAPITypes.METHOD_KEY.LOR_DECK.GET_DECKS_FOR_PLAYER, {}, {
                id: `${region}.lorDeck.getDecksForPlayer`,
                headers: { Authorization: `Bearer ${accessToken}` },
            }),
            createDeck: ({ region, accessToken, body, }) => this.request(region, _types_1.RiotAPITypes.METHOD_KEY.LOR_DECK.POST_CREATE_DECK_FOR_PLAYER, {}, {
    ...
    get lorInventory() {
        return {
            getCardsOwnedByPlayer: ({ region, accessToken, }) => this.request(region, _types_1.RiotAPITypes.METHOD_KEY.LOR_INVENTORY.GET_CARDS_OWNED_BY_PLAYER, {}, {
    ...
    get summoner() {
        return {
            getByRsoPUUID: ({ region, rsoPuuid, }) => this.request(region, _types_1.RiotAPITypes.METHOD_KEY.SUMMONER.GET_BY_RSO_PUUID, { rsoPuuid }, { id: `${region}.summoner.getByRsoPUUID.${rsoPuuid}` }),
    ...
    get tftLeague() {
        return {
            ...
            getTopRatedLadderByQueue: ({ region, queue, }) => this.request(region, _types_1.RiotAPITypes.METHOD_KEY.TFT_LEAGUE.GET_TOP_RATED_LADDER_BY_QUEUE, { queue }, { id: `${region}.tftLeague.getTopRatedLadderByQueue.${queue}` }),
        };
    }
    get tftMatch() {
        return {
    ...
    get tftSummoner() {
        return {
            ...
            getByAccessToken: ({ region, accessToken, }) => this.request(region, _types_1.RiotAPITypes.METHOD_KEY.TFT_SUMMONER.GET_BY_ACCESS_TOKEN, {}, {
    ...
    get valRanked() {
        return {
            getLeaderboardByQueue: ({ region, queue, params, }) => this.request(region, _types_1.RiotAPITypes.METHOD_KEY.VAL_RANKED.GET_LEADERBOARD_BY_QUEUE, { actId: queue }, { id: `${region}.valRanked.getLeaderboardByQueue.${queue}`, params }),
        };
    }
}
