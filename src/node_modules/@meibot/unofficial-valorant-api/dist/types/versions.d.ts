...
export type RawResponse<T> = T extends "matchdetails" ? RawMatchDetailsResponse : T extends "matchhistory" ? RawMatchHistoryResponse : T extends "mmr" ? RawMMRResponse : T extends "competitiveupdates" ? RawCompetitiveUpdatesResponse : never;
